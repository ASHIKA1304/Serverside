...
<h2 align="center">ASHIKA</h2>
<h3 align="center">212224220011</h3>
...
def rightcylinder(request):
    ...
    return render(request, 'ss1app/front.html', context)

urls.py
from django.contrib import admin
from django.urls import path
from ss1app import views
urlpatterns = [
...
![alt text](<Screenshot 2025-04-23 085804.png>)

## HOMEPAGE:
![alt text](<Screenshot 2025-04-23 085751.png>)
